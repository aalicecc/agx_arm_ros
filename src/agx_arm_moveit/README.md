...
1）二进制安装，[参考链接](https://moveit.ai/install/)

```bash
sudo apt install ros-$ROS_DISTRO-moveit*
```

2）源码编译方法，[参考链接](https://moveit.ai/install/source/)

---

## 2 安装依赖

安装完Moveit之后，需要安装一些依赖
...
启动 moveit 前，先开启机械臂控制节点，详见：[agx_arm_ctrl](../../README.md)
